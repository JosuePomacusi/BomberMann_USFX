...
public:
    ...
    int bombas = 1;
  /*  int bangSpawnCellsX = 5;  */     // bang spawn number of cells

     /*int bangSpawnPositionsX[bombas][2] = { {0, 0},
                                                   {0, 1},
                                                   {1, 0},
                                                   {0, -1},
    ...
    virtual void update(const unsigned int delta) override;
     ...
     //int bangSpawnPositions[bangSpawnCells][2] = { {0, 0},
     //                                              {0, 1},
     //                                              {1, 0},
     //                                              {0, -1},
     //                                              {-1, 0} }; // cell's position of bang
...
private:
    ...
    void spawnItemBoombaTamaño(GameGraphicObject* object);
    ...
    void destroyBrickItem(std::shared_ptr<GameGraphicObject> brick);
    ...
    std::shared_ptr<Sprite>  doorItemBomba = nullptr;
